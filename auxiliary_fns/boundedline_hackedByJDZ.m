%%% Note:
%%% This is a hacked version. The original function plots the shaded patch
%%% without edges. This version adds edges for the shaded patch, with
%%% colour & linestyle matching the linespec for the line.
%%%
%%% Modified line 356:
%%%    hp(iln) = patch(xp{iln}, yp{iln}, ptchcol{iln}, 'facealpha', alpha{iln}, 'edgecolor', 'none', 'parent', hax);
%%% to:
%%%    hp(iln) = patch(xp{iln}, yp{iln}, ptchcol{iln}, 'facealpha', alpha{iln}, 'edgecolor', lncol{iln}, 'LineStyle', lnsty{iln}, 'parent', hax);
%%%
%%% https://au.mathworks.com/help/matlab/ref/matlab.graphics.primitive.patch-properties.html#buduav0-1_sep_shared-EdgeColor
%%%

function varargout = boundedline_hackedByJDZ(varargin)
